...
#ifndef APPCELERATORBLE_SWIFT_H
#define APPCELERATORBLE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AppceleratorBle",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif



SWIFT_CLASS("_TtC15AppceleratorBle28TiBLEPeripheralProviderProxy")
@interface TiBLEPeripheralProviderProxy : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


SWIFT_CLASS("_TtC15AppceleratorBle20TiBLEPeripheralProxy")
@interface TiBLEPeripheralProxy : TiProxy
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
@interface TiBLEPeripheralProxy (SWIFT_EXTENSION(AppceleratorBle)) <CBPeripheralDelegate>
