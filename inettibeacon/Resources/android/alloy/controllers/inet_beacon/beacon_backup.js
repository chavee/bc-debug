...
function Controller() {
  ...
  this.__controllerPath = 'inet_beacon/beacon_backup';
  ...
  function getLocation(this_major, this_minor, this_key) {
    ...
    xhr.onload = function (e) {
      ...
      global_beacons[this_key]["isRegitered"] = true;
    ...
    xhr.onerror = function (e) {
      ...
      if (this.status = 404)
      {
        global_beacons[this_key]["location"] = "ไม่พบตำแหน่งในระบบ";
      } else
...
//# sourceMappingURL=file://d:\GIANT\ww2\bc-debug\inettibeacon/build/map/Resources\android\alloy\controllers\inet_beacon\beacon_backup.js.map